...
## Key Results
The champion model is an **XGBoost Classifier** trained on a compact, highly engineered set of physical representations. It achieves a test accuracy of **80.62%** on separating EX1 from EX3 at $z=0.1$.
...
## Usage
To evaluate the 80.62% accuracy benchmark:
